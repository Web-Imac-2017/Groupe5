<template>
  <div class="header">
    <router-link v-bind:to="'/home/'"><img v-bind:src="'http://www.plume.ink/public_html/static/img/logo.png'" class="headerlogo"></router-link>
    ...
    <router-link class="item" v-bind:to="'/match/'">MATCHING</router-link>
