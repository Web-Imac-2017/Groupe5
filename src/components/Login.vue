<template>
  <div class="connexion" v-bind:style="{backgroundImage: 'url(http://www.plume.ink/public_html/static/img/bg.jpg)'}">
    ...
    <div class="wrapper">
      <!-- <h1>Connexion</h1> -->
      <img v-bind:src="'http://www.plume.ink/public_html/static/img/logo.png'" class="loginlogo">
